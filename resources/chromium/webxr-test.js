...
class MockRuntime {
  ...
  setViews(primaryViews, secondaryViews) {
    ...
    if (primaryViews) {
      this.primaryViews_ = [];
      xOffset = this._setViews(primaryViews, this.primaryViews_, xOffset);
    }

    if (secondaryViews) {
      this.secondaryViews_ = [];
      this._setViews(secondaryViews, this.secondaryViews_, xOffset);
    }
  ...
  _setViews(deviceViews, views, xOffset) {
